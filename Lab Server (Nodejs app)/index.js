...
app.get("/roomlist", async (req, res)=>{
    let list = [
        JSON.stringify({roomID:"room_2651", size: "8/10", hostName: "Tamzid"}),
        JSON.stringify({roomID:"room_7611", size: "5/10", hostName: "_exp3rt"}),
        JSON.stringify({roomID:"room_6654", size: "3/10", hostName: "carbon"}),
    ]
    //list = [];
...
>>>>>>> 57975f0 (Initial Unity project commit)
